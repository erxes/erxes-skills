...
ERXES_APP_TOKEN=sk_807492ebbfc8a1052e31f35c15a1261ad3bbc216a996c66a
ERXES_POS_TOKEN=dFhsNNfym9wDdoKIHU7s3b8Ip3iNhjQG
ERXES_BRAND_CODE=mRugDycpAY52Ds3fQ6oBI
```
...
| ----------------------- | --------------------------- | ---------------------------------- |
| Screen queries (client) | `EXPO_PUBLIC_ERXES_API_URL` | `erxes-app-token`                  |
| CMS seed mutations      | `ERXES_API_URL`             | `x-app-token: CLIENT_PORTAL_TOKEN` |
| Server-side scripts     | `ERXES_API_URL`             | `x-app-token: CLIENT_PORTAL_TOKEN` |
