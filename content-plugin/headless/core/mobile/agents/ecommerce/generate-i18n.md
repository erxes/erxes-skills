...
`messages/mn.json` болон `messages/en.json` — доорх бүрэн агуулгыг ашиглана (web-ийн `agents/ecommerce/generate-i18n.md`-тэй тэнцүү; энд inline өгсөн тул web файл унших шаардлагагүй). Хэрэв шинээр key нэмвэл хоёр файлд хамт нэм.
